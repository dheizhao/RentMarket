						...
						<div class="mc">
							...
							<div class="qrcode-main">
								...
								<div class="qrcode-img" style="">
									...
									<div class="qrcode-error-02 hide" id="J-qrcodeerror"
										style="display: none;">
							...
							<div class="qrcode-panel">
								<ul>
									<li class="fore1"><span>打开</span> <a href=""> <span
											class="red">手机歪秀购物 </span>
									</a></li>
									<li>扫一扫登录</li>
								</ul>
							</div>
			...
			<div class="login-banner" style="background-color: #ea4949">
				<div class="w">
					<div id="banner-bg" class="i-inner"
						style="background: url(theme/login/a1.jpg);"></div>
				</div>
			</div>
		</div>
	</div>
		...
		<div id="footer-2013">
			<div class="links">
				<a href="">关于我们</a> | <a href="">联系我们</a> | <a href="">人才招聘</a> | <a
					...
					href="">友情链接</a> | <a href="">销售联盟</a> | <a href="">English
					site</a>
			</div>
